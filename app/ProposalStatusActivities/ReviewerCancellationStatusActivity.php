...
class ReviewerCancellationStatusActivity extends StatusActivity
{

    public static $type = 'reviewer_cancellation';
    ...
    public function buildViewDataApplicationHistory(User $user = null)
    {
        ...
        $viewString = "<span class='font-bold'>$reviewerString</span> has been removed from the proposal's reviewers.";
        return $viewString;
