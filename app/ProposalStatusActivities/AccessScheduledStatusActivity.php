...
class AccessScheduledStatusActivity extends StatusActivity
{

    public static $type = 'access_scheduled';
    ...
    public function buildViewDataApplicationHistory(User $user = null)
    {
        ...
        $viewString = "The access for the service " .
            "<span class='italic'>$serviceString</span> has been scheduled.<br/> ";
