...
class ReviewerAcceptanceStatusActivity extends StatusActivity
{

    public static $type = 'reviewer_acceptance';
    ...
    public function buildViewDataApplicationHistory(User $user = null)
    {
        ...
        $viewString = "<span class='font-bold'>$reviewerString</span> has accepted to review the proposal!";
        return $viewString;
