...
<div class="flex items-center justify-center">
    ...
    {{-- @if (JoelButcher\Socialstream\Socialstream::hasOrcidSupport())
    <a href="{{ route('oauth.redirect', ['provider' => JoelButcher\Socialstream\Providers::orcid()]) }}">
        <x-socialstream-icons.orcid />
